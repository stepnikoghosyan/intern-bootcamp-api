...
export abstract class BaseService<T extends any = ModelCtor<Model<any, any>>> {
  ...
  constructor(model: any) { // Cannot figure out how to put type here
    this.DB_MODEL = model;
  }
  ...
  public async getByPagination(queryParams: IPaginationQueryParams): Promise<IPaginationResponse<T>> {
  ...
  protected getPaginationValues(params: IPaginationQueryParams): { limit: number; offset: number } | {} {
